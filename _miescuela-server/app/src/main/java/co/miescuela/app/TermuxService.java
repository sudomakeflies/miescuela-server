...
public final class TermuxService extends Service implements SessionChangedCallback {
    ...
    public static final String FILES_PATH = "/data/data/co.miescuela/files";
    public static final String PREFIX_PATH = FILES_PATH + "/usr";
    public static final String HOME_PATH = FILES_PATH + "/home";

    private static final int NOTIFICATION_ID = 1337;

    private static final String ACTION_STOP_SERVICE = "co.miescuela.service_stop";
    private static final String ACTION_LOCK_WAKE = "co.miescuela.service_wake_lock";
    private static final String ACTION_UNLOCK_WAKE = "co.miescuela.service_wake_unlock";
    /** Intent action to launch a new terminal session. Executed from TermuxWidgetProvider. */
    public static final String ACTION_EXECUTE = "co.miescuela.service_execute";

    public static final String EXTRA_ARGUMENTS = "co.miescuela.execute.arguments";

    public static final String EXTRA_CURRENT_WORKING_DIRECTORY = "co.miescuela.execute.cwd";
    ...
    TerminalSession createTermSession(String executablePath, String[] arguments, String cwd, boolean failSafe) {
        ...
        Intent stylingIntent = new Intent("co.miescuela.app.reload_style");
        stylingIntent.putExtra("co.miescuela.app.reload_style", "styling");
